...
function bloggerFunc($userId) {
    ...
    //Проверка наличия подписчиков у пользователя
...
function editStatus($userId) {
    ...
    //Обновление статуса пользователя, в зависимости от количества баллов в системе
...
<body class="autorisation-body">
    ...
    <script>
        ...
        window.addEventListener("DOMContentLoaded", function() {
            //Обработка элемента с id=LoginInput
            [].forEach.call(document.querySelectorAll('#LoginInput'), function(input) {
                var keyCode; //Хранение кода нажатой клавиши
                
                //Функция для маски ввода
                function mask(event) {
                    ...
                    var matrix = "+7 (___) ___ __ __",
                        ...
                        new_value = matrix.replace(/[_\d]/g, function(a) {
                            //Заполнение маски введенными значениями
                    ...
                    reg = new RegExp("^" + reg + "$"); //Проверка формата
